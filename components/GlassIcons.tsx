...
const GlassIcons: React.FC<GlassIconsProps> = ({ items, className, columns }) => {
  const gridColsClass =
    columns === 6
  ...
  const gapClass = columns === 6 ? 'gap-[3em] md:gap-[4em]' : 'gap-[5em]';
  ...
  return (
    <div className={`grid ${gapClass} ${gridColsClass} mx-auto py-[3em] overflow-visible ${className || ''}`}>
